print("\nAddition of many polynomial features often leads to \n overfitting, so we use polynomial features with regression algorithm that has a penalty feature like ridge regression")
...
linreg=Ridge(alpha=500).fit(X_train,y_train)
